...
export const metadata = {
  title: {
    ...
    default: 'Emergency Dental Treatment UK Wide | ' + process.env.NEXT_PUBLIC_SITE_NAME,
  },
  description: {
    template: '%s',
  ...
  // Add canonical URL
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://yourdomain.co.uk'),
  ...
  keywords: ['emergency dental care', 'dentist UK', 'tooth pain', 'dental clinic', 'dental services', 'urgent dental care', 'NHS dentist'],
